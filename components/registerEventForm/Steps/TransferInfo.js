  ...
  useEffect(() => {
    editEvent
      ? (setStatEvent(""),
        setEndEvent(""),
        setTravelInfo({
          tavel_start_description: editEvent.tavel_start_description,
          travel_days: editEvent.travel_days,
        }))
      : setTravelInfo({});
  }, [editEvent]);
  return (
    <Grid container>
      <Grid item style={{ paddingBottom: "25px" }}>
        <Typography variant="h6">اطلاعات حرکت</Typography>
      </Grid>
      <Grid container>
        <Grid style={{ paddingBottom: "25px" }} item>
          <Grid item>
            <Typography variant="h6">مدت برنامه</Typography>
          </Grid>
      ...
      <Grid container style={{ paddingBottom: "30px" }}>
        <Grid item xs={12} sm={4} md={4} lg={4}>
          <Grid item>
            <Typography variant="subtitle1">تاریخ رفت </Typography>
          </Grid>
          <Grid item>
            <JalaliCalander
              editEvent={editEvent}
        ...
        <Grid item xs={12} sm={4} md={4} lg={4}>
          <Grid item>
            <Typography variant="subtitle1">تاریخ برگشت </Typography>
          </Grid>
          <Grid item>
            <JalaliCalander
      ...
      >
        <Grid item>
          <Typography variant="h6"> توضیحات اطلاعات حرکت </Typography>
        </Grid>
        <Grid item style={{ padding: "20px 20px 0 20px" }}>
          <TextField
            ...
            multiline
            rows={2}
            placeholder="توضیح جزییات از نحوه و محل حرکت ... "
          />
        </Grid>
      </Grid>
    </Grid>
